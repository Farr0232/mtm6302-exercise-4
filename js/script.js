...
// When the Clear button is clicked, hide the countdown, unhide the form, and reset it and remove event from local storage
...
// Create a variable for the timer using setInterval 
...
function getEventFromStorage() {
    ...
    const ls = localStorage.getItem('event')
    ...
    if (ls) {
        ...
        const savedEvent = JSON.parse(ls)
